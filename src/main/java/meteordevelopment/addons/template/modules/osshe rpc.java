...
public class discordrpc extends Module {
    ...
    List<String> line2Strings = Collections.singletonList("https://discord.gg/TQDQJYqvvS");
    ...
    public discordrpc() {
        super(KarasicAddon.karasic, "osshe-rpc", "osshe rpc cause cool");
    }
    ...
    public WWidget getWidget(GuiTheme theme) {
        WButton help = theme.button("Join Nosshe Anarchy Essentials!");
        help.action = () -> Util.getOperatingSystem().open(bedtrap());
        WButton git = theme.button("github here");
        git.action = () -> Util.getOperatingSystem().open("https://github.com/Dasyat1s/osshe-rpc");
        return help;
    }}
